...
import VELI
import requests
from VELI.lib.curve.ttypes import *
...
kb = VELI.LINE()
kb.login(token='EmrJUZrg8rD5z1J12dQb.qaa9LxAyZw+xJR8OpGpicW.dCB6J0cHqgs1F6/1WY8AO+hzWJRTYhk562C32y+i38M=')
kb.loginResult

ky = VELI.LINE()
ky.login(token='EmDkq665BzCI0y4AYne2.13vQkhomVAv5TPNiweN+iG.teasThr90UZV4yBo0xH9pJvMEmHwbFyQa3eV6OFgRZw=')
ky.loginResult
...
admin=["ua7fb5762d5066629323d113e1266e8ca","uc8e2c2b906e2322592c6d8f91a0957f7","uf4a837a5f4e413ac811d790f8f578bc9"]
creator=["ua7fb5762d5066629323d113e1266e8ca","uc8e2c2b906e2322592c6d8f91a0957f7","uf4a837a5f4e413ac811d790f8f578bc9"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~naufal_opalminecraft",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~naufal_opalminecraft",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif ("Veli1 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Veli1 gn ","")
						ki.updateGroup(X)
					else:
						ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Veli2 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Veli2 gn ","")
						kk.updateGroup(X)
					else:
						kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Veli3 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Veli3 gn ","")
						kc.updateGroup(X)
					else:
            ...
            elif "Veli1 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli1 kick ","")
					ki.kickoutFromGroup(msg.to,[midd])
            elif "Veli2 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli2 kick ","")
					kk.kickoutFromGroup(msg.to,[midd])
            elif "Veli3 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli3 kick ","")
            ...
            elif "Veli1 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli1 invite ","")
					ki.findAndAddContactsByMid(midd)
					ki.inviteIntoGroup(msg.to,[midd])
            elif "Veli2 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli2 invite ","")
					kk.findAndAddContactsByMid(midd)
					kk.inviteIntoGroup(msg.to,[midd])
            elif "Veli3 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Veli3 invite ","")
				...
				if msg.from_ in admin:
					...
					cl.sendMessage(msg)
            elif msg.text in ["Veli1"]:
				if msg.from_ in admin:
					msg.contentType = 13
					msg.contentMetadata = {'mid': Amid}
					ki.sendMessage(msg)
            elif msg.text in ["Veli2"]:
				if msg.from_ in admin:
					msg.contentType = 13
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Di sini Veli")
					ki.sendText(msg.to,"Di sini Steli")
					cl.sendText(msg.to,"Di sini Sasuke")
					ki.sendText(msg.to,"Di sini Fikas")
#-----------------------------------------------
            elif "Veli say " in msg.text:
					bctxt = msg.text.replace("Veli say ","")
					...
					cl.sendText(msg.to,"MyCreator: Naufal Blaze")
					ki.sendMessage(msg)
					msg.contentType = 13
					msg.contentMetadata = {'mid': "uf4a837a5f4e413ac811d790f8f578bc9"}
					cl.sendText(msg.to,"MyCreator: Rido")
					ki.sendMessage(msg)
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line:://ti/p/~naufal_opalminecraft")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Channel Youtube : Naufal Blaze")
						print "DiLike"
					except:
							pass
				else:
