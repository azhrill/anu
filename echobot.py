...
#bot.login(qr=True)
#bot.login(token="Elyuo1wVhXHUo2mxbA89.PDnMfzlaVotoVy94KLYOEq.FLJNu4gHLj3ZdlcyaMJtzC/q2B+eeqWHuWrmSbRg3UI=")

cl = LineAlpha.LINE()
cl.login(token="Elyuo1wVhXHUo2mxbA89.PDnMfzlaVotoVy94KLYOEq.FLJNu4gHLj3ZdlcyaMJtzC/q2B+eeqWHuWrmSbRg3UI=")
cl.loginResult()

kk = LineAlpha.LINE()
kk.login(token="Elzsi4SOQBejg9wlqdke.KR1tzTRASj+DuqomtrDA3G.VD9Pz+wA0I2/O2gGwItTyTLHg1q5NPQBU3wehw3pLSo=")
kk.loginResult()

ki = LineAlpha.LINE()
ki.login(token="ElUQSW1E91deMxzvuKjf./qV3aedEXYtKJUMJkijfZW.Ba0n1f3oMaroYLYvbs0HBhHv+FVxlcg8lBriRm7zeEo=")
ki.loginResult()

kc = LineAlpha.LINE()
kc.login(token="ElMG7J0eOb8ywKm4jIQ5.ITtwe7OE8DiD0MS5S3CXDq.DZVM3BkBa8AMBa2H6DYexQT1Tg+z+rBA78nxwCcloHA=")
kc.loginResult()

kg = LineAlpha.LINE()
kg.login(token="El47gvfQotOWYYvz47Q4.rXCoxdtA3LKP8aI4hKXdHa.RpRGGMNkMpzObhSOoh0eYgJrtj+bhXL/2Q3ZtHDaGJE=")
kg.loginResult()

#selfbot (akun sendiri) cuman dibutuhin kalo mau auto join kalo di kick

adm = LineAlpha.LINE()
adm.login(token="ElB372J5K1KqFgh0nYU2.kl7JoLLRd6/3pwatLZiCiG.3GP5WOhw6tdxWP/F51D3899groSslxVEBJnUPYGsEf8=")
adm.loginResult()
...
helpMessage ="""[RHN] Bot(s) Command list:
...
⚠[/Join all] - Join All bot
⚠[/Bersihkan] - Clear all members in the group
⚠[/Bye all] - Bot Leave
⚠[/Ban 「@」] - Ban By Tag
⚠[/Unban 「@」] - Unban By Tag
...
admin = ["u28bee33a596b0fafb73d601397321c22"]
staff = ["u28bee33a596b0fafb73d601397321c22"]
adminMID = "u28bee33a596b0fafb73d601397321c22"
wait = {
    'contact':True,
    'autoJoin':True,
...
#-----------------------[Bot/User/Group ID Section]------------------------
                ...
                cl.sendText(msg.to,"[RHN-]Bot(s) ID\n[RHN]BOT1\n" + mid + "\n\n[RHN]BOT2\n" + Amid + "\n\n[RHN]BOT3\n" + Bmid + "\n\n[RHN]BOT4\n" + Cmid + "\n\n[RHN]BOT5\n" + Dmid)
...
#-----------------------[Cleanse Section (USE AT YOUR OWN RISK!)]------------------------
            elif msg.text in ["/Bersihkan","/bersihkan"]:
                if msg.toType == 2:
                    if msg.from_ in admin:
